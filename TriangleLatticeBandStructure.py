...
def calculate(rIn, epsIn, geometryIsHole=False, k_interpIn = 8, resolutionIn = 64, num_bandsIn = 8,
                mesh_sizeIn = 3, runTEorTMorAll = 'all', suppressInfo = False, isDebugging = True):
    ...
    cylinder = mp.geometric_objects_lattice_duplicates(geometry_lattice, cylinder)
...
def calculateFirstBandGap(r, runTEorTM='run_te',  eps=1, bandgapMultipler = -1):
    bandgap = calculate(r, eps, geometryIsHole = True, k_interpIn = 16, num_bandsIn = 2, resolutionIn = 128, runTEorTMorAll=runTEorTM)
...
if __name__ == "__main__":
    ...
    calculate(r0, eps0, geometryIsHole = True, k_interpIn = 16, num_bandsIn = 2, resolutionIn = 32, mesh_sizeIn=0, runTEorTMorAll='run_te')          
