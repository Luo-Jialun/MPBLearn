...
def calculate(rIn, epsIn, geometryIsHole=False, k_interpIn = 8, resolutionIn = 64, num_bandsIn = 8,
                mesh_sizeIn = 3, runTEorTMorAll = 'all', suppressInfo = False, isDebugging = True, centerCylinderRadius = 0.2, removeMiddleCylinder=False, latticeType='triangle', superCellSize = 3):
